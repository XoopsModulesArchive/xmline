...
$sform = new XoopsThemeForm(_AM_XMLINE_CATEGORY, "categoryform", xoops_getenv('PHP_SELF'));
$sform->setExtra('enctype="multipart/form-data"');

$sform->addElement(new XoopsFormText(_AM_XMLINE_TITLE, 'title', 50, 255, $title), true);
$sform->addElement(new XoopsFormText(_AM_XMLINE_ORDER, 'category_order', 20, 20, $category_order), false);
...
$button_tray->addElement(new XoopsFormButton('', '', _AM_XMLINE_CANCEL, 'button'));
